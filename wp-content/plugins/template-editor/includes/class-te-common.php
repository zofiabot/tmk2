...
if (!class_exists('teCommon')) {
	...
	class teCommon {
        ...
        public static $plugin_name = 'Template Editor';
        public static $plugin_prefix = 'te';
        public static $plugin_text_domain = 'template-editor';
		...
		public static function plugin_version() {
            ...
            return template_editor_class::$version;
