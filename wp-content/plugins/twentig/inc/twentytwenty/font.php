...
function twentig_fonts_url() {
	...
	if ( isset( $fonts[ $logo_font ] ) && ! has_custom_logo() ) {
...
function twentig_logo_font_url() {
	...
	if ( ! has_custom_logo() && $logo_font && 'sans-serif' !== $logo_font ) {
		...
		if ( $body_font === $logo_font || $heading_font === $logo_font ) {
			return '';
		}
...
function twentig_twentytwenty_get_font_presets() {
	...
	$presets = array(
		...
		array(
			...
			'image' => 'system.png',
			'mods'  => array(
				'twentig_body_font'              => 'sans-serif',
				'twentig_body_font_size'         => 'small',
				'twentig_body_line_height'       => 'medium',
				'twentig_heading_font'           => 'sans-serif',
				'twentig_heading_font_weight'    => '700',
				'twentig_heading_letter_spacing' => '',
