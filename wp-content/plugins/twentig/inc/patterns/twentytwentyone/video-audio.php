...
twentig_register_block_pattern(
	...
	array(
		...
		'categories' => array( 'video-audio' ),
		'content'    => '<!-- wp:group {"align":"full"} --><div class="wp-block-group alignfull"><!-- wp:heading {"textAlign":"center","className":"tw-mb-8"} --><h2 class="has-text-align-center tw-mb-8">' . esc_html_x( 'All episodes', 'Block pattern content', 'twentig' ) . '</h2><!-- /wp:heading --><!-- wp:heading {"level":3,"fontSize":"medium"} --><h3 class="has-medium-font-size">01: Lorem ipsum dolor sit amet</h3><!-- /wp:heading --><!-- wp:audio {"className":"tw-mt-0"} --><figure class="wp-block-audio tw-mt-0"><audio controls src="https://s.w.org/audio.mp3"></audio></figure><!-- /wp:audio --><!-- wp:separator --><hr class="wp-block-separator"/><!-- /wp:separator --><!-- wp:heading {"level":3,"fontSize":"medium"} --><h3 class="has-medium-font-size">02: Integer enim risus suscipit eu iaculis sed</h3><!-- /wp:heading --><!-- wp:audio {"className":"tw-mt-0"} --><figure class="wp-block-audio tw-mt-0"><audio controls src="https://s.w.org/audio.mp3"></audio></figure><!-- /wp:audio --><!-- wp:separator --><hr class="wp-block-separator"/><!-- /wp:separator --><!-- wp:heading {"level":3,"fontSize":"medium"} --><h3 class="has-medium-font-size">03: Aliquam tempus mi eu nulla porta luctus</h3><!-- /wp:heading --><!-- wp:audio {"className":"tw-mt-0"} --><figure class="wp-block-audio tw-mt-0"><audio controls src="https://s.w.org/audio.mp3"></audio></figure><!-- /wp:audio --></div><!-- /wp:group -->',
	)
);
