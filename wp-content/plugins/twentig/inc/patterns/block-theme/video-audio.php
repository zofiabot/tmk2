...
twentig_register_block_pattern(
	...
	array(
		...
		'categories' => array( 'video-audio' ),
		'content'    => '<!-- wp:group {"align":"full","layout":{"inherit":true}} --><div class="wp-block-group alignfull"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"bottom":"60px"}}}} --><h2 class="has-text-align-center" style="margin-bottom:60px">' . esc_html_x( 'All episodes', 'Block pattern content', 'twentig' ) . '</h2><!-- /wp:heading --><!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.125em"}}} --><h3 style="font-size:1.125em">01. Lorem ipsum dolor sit amet</h3><!-- /wp:heading --><!-- wp:audio {"className":"tw-mt-4"} --><figure class="wp-block-audio tw-mt-4"><audio controls src="https://s.w.org/audio.mp3"></audio></figure><!-- /wp:audio --><!-- wp:separator {"className":"tw-mb-6 tw-mt-6 is-style-wide"} --><hr class="wp-block-separator tw-mb-6 tw-mt-6 is-style-wide"/><!-- /wp:separator --><!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.125em"}}} --><h3 style="font-size:1.125em">02. Integer enim risus suscipit eu iaculis sed</h3><!-- /wp:heading --><!-- wp:audio {"className":"tw-mt-4"} --><figure class="wp-block-audio tw-mt-4"><audio controls src="https://s.w.org/audio.mp3"></audio></figure><!-- /wp:audio --><!-- wp:separator {"className":"tw-mb-6 tw-mt-6 is-style-wide"} --><hr class="wp-block-separator tw-mb-6 tw-mt-6 is-style-wide"/><!-- /wp:separator --><!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.125em"}}} --><h3 style="font-size:1.125em">03. Aliquam tempus mi eu nulla porta luctus</h3><!-- /wp:heading --><!-- wp:audio {"className":"tw-mt-4"} --><figure class="wp-block-audio tw-mt-4"><audio controls src="https://s.w.org/audio.mp3"></audio></figure><!-- /wp:audio --></div><!-- /wp:group -->',
	)
);
